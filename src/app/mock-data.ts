...
export const WHISKEYS: Whiskey[] = [
    { id: "0", name: "Macallan Edition No. 3", active: true },
    { id: "1", name: "Macallan Edition No. 4", active: true },
    { id: "2", name: "Yamazaki 12 Year", active: true }, 
    { id: "3", name: "Yamazaki 15 Year", active: true },
    { id: "4", name: "Nikka Hokkaido-Yoichi", active: true }
];

export const WHISKEY_PRICES: WhiskeyPrice[] = [
    { id: "0", whiskeyId: "0", date: new Date("2020-10-01"), price: 343, active: true },
    { id: "1", whiskeyId: "1", date: new Date("2020-10-01"), price: 214, active: true },
    { id: "2", whiskeyId: "2", date: new Date("2020-10-01"), price: 154, active: true },
    { id: "3", whiskeyId: "3", date: new Date("2020-10-01"), price: 605, active: true },
    { id: "4", whiskeyId: "4", date: new Date("2020-12-01"), price: 134, active: true }
];
